...
export default function Sidebar({ user }: { user: User }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "1.5rem 1.25rem 1.25rem" }}>
        ...
        <h2
          style={{
            ...
            fontWeight: 800,
            color: "#00e5ff",
            textShadow: "0 0 12px rgba(0,229,255,0.7), 0 0 25px rgba(0,229,255,0.3)",
      ...
      {/* Footer */}
      <div style={{ padding:"1rem 1.25rem",borderTop:"1px solid rgba(0,229,255,0.08)" }}>
        <p style={{ fontSize:"0.7rem",color:"rgba(74,85,128,0.7)",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",marginBottom:"0.5rem" }}>
          {user.email}
        </p>
        <button
